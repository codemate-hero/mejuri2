            ...
            <section className="mt-[95px] w-full">
                <div className="flex flex-col lg:flex-row h-[700px]">
                    ...
                    <div className="w-full lg:w-1/2 h-[420px] lg:h-full">
                        <img
                            src="https://res.cloudinary.com/mejuri-com/image/upload/q_auto,f_auto/v1778862710/Store%20Led%20Events/Milestone_Landing_Hero_M.jpg"
                            alt="Piercing Hero"
                    ...
                    <div className="w-full lg:w-1/2 bg-black flex items-center">
                        <div className="px-10 lg:px-20">
                            <h1 className="text-white text-[34px] lg:text-[2rem] font-semibold uppercase tracking-[2px] leading-[1.05] mb-8">
                                BOOK A BRIDAL SESSION
                            </h1>

                            <p
                                className="text-white font-mono text-[.875rem] leading-[1.33] tracking-[-.01em]"
                            >
                                Consider your ‘something new’ handled. Gather your bridal party for a dedicated session of sips and shopping—plus up to 15% off to get the party started.
                            </p>
                        </div>
                    </div>
