...
export function Navbar({
  ...
  return (
    <>
      <header className={`fixed left-0 right-0 z-[60] h-[57px] transition-all duration-300 ${hidePromoBar ? "top-0" : "top-0 lg:top-[38px]"} ${variant === "light"
        ? (isScrolled ? "bg-white text-black" : "bg-white text-black")
        : (isScrolled ? "bg-black text-white" : "bg-black/0 text-white")
        }`}>
        <div className="mx-auto flex h-full max-w-[1920px] items-center justify-between py-[1rem] px-[2rem] ">
          <div className="flex w-1/3 items-center lg:w-auto lg:flex-initial lg:gap-9">
            ...
            <nav className="hidden items-center gap-7 font-sans text-[13px] font-normal lg:flex">
              {links.map((link) => {
          ...
          <div className="flex w-1/3 items-center justify-end font-sans text-[13px] font-normal lg:w-auto gap-[1rem]">
            <button
