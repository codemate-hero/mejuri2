...
export const categoryMapping: Record<string, { collectionHandle?: string; category?: string; productType?: string; q?: string; tags?: string[] }> = {
  ...
  "mens-jewelry": { collectionHandle: "mens" },
  "gift-guide": { collectionHandle: "all-gifts" },
  "all-gifts": { collectionHandle: "all-gifts" },
  "most-gifted": { collectionHandle: "all-gifts" },
  "jewelry-gifts-under-500": { collectionHandle: "jewelry-gifts-under-500" },
  "luxury-gifts": { collectionHandle: "luxury-gifts" },
  "all-personalized": { collectionHandle: "engravable-jewelry" },
  "birthstone-and-zodiac": { collectionHandle: "birthstone-zodiac" },
  "the-letter-shop": { collectionHandle: "all-gifts", q: "letter" },
  "gifts-over-200": { collectionHandle: "gifts-over-200" },
  "birthstone-zodiac": { collectionHandle: "birthstone-zodiac" },
  "engravable-jewelry": { collectionHandle: "engravable-jewelry" },
  "gifts-for-him": { collectionHandle: "mens" },
  ...
  "june-birthstone": { collectionHandle: "birthstone-zodiac" },
  "july-birthstone": { collectionHandle: "birthstone-zodiac" },
  "graduation-gifts": { collectionHandle: "all-gifts" },
